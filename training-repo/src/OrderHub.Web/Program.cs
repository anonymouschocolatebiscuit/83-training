...
// Gemini:設定 + typed HttpClient + 分層接線(key 走 user-secrets Gemini:ApiKey)
builder.Services.Configure<GeminiOptions>(builder.Configuration.GetSection(GeminiOptions.SectionName));
builder.Services.AddHttpClient<IGeminiJsonClient, GeminiGenerateContentClient>();
...
app.MapControllers();   // 讓 [ApiController] 的屬性路由(api/orders/search)生效
